...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF5EABD6);
  late Color secondary = const Color(0xFF80D8C3);
  late Color tertiary = const Color(0xFFCA7842);
  late Color alternate = const Color(0xFF78C841);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF273F4F);
  late Color primaryBackground = const Color(0xFFDCC5B2);
  late Color secondaryBackground = const Color(0xFFFAF7F3);
  late Color accent1 = const Color(0xFF3163E4);
  late Color accent2 = const Color(0xFF39D285);
