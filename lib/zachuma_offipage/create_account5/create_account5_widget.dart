...
class _CreateAccount5WidgetState extends State<CreateAccount5Widget> {
  ...
  void initState() {
    ...
    _model.passwrdTextController ??= TextEditingController();
    _model.passwrdFocusNode ??= FocusNode();
  }
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      16.0, 12.0, 16.0, 12.0),
                                  child: TextFormField(
                                    controller: _model.passwrdTextController,
                                    focusNode: _model.passwrdFocusNode,
                                    autofocus: false,
                                    textCapitalization: TextCapitalization.none,
                                    obscureText: !_model.passwrdVisibility,
                                    decoration: InputDecoration(
                                      labelText: 'Password',
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelLarge
                                    ...
                                    validator: _model
                                        .passwrdTextControllerValidator
                                        .asValidator(context),
                                    inputFormatters: [
                                      if (!isAndroid && !isiOS)
                                        TextInputFormatter.withFunction(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              final user =
                                ...
                                _model.passwrdTextController.text,
                              );
                              if (user == null) {
                                return;
                              }
                              ...
                              await UsersTable().insert({
                                ...
                                'created_at': supaSerialize<DateTime>(
                                    getCurrentTimestamp),
                                'user_name': _model.fnameTextController.text,
